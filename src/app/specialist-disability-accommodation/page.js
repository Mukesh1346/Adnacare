                            ...
                            <div className="SpecialistAccommodationRightSec">
                                <div className='SpecialistAccommodationTextSec'>
                                    ...
                                    <ul className='SpecialistAccommodationSubTitle '>
                                        ...
                                        <li>At Adnacare support services Assist, all our homes are staffed 24/7 and provide access to a range of specialist services such as health, clinical and positive behaviour support.</li>

                                    </ul>
                       <b className='ThemeTitle'>Adnacare support services Assist offers a range of Specialised Disability Accommodation (SDA) properties across Sydney, New South Wales regional and metropolitan areas.</b>
