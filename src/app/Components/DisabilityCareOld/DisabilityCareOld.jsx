        ...
        <div className="row align-items-center">
          <div className="col-lg-6">
            ...
            <p className="hero-text">
              At OSAN Ability, we provide one of the most caring disability care services in Sydney. our team includes professional, experienced and devoted Disability Support Workers, Registered Nurses, and Assistants in Nursing, Occupational Therapists, Handymen and Garden crew, providing high quality services to our clients.
            </p>
               <b>Disability Support Services for Elderly Individuals</b>
            <p>At OSAN Ability, we are dedicated to providing exceptional disability care services tailored to the unique needs of seniors. With extensive experience serving elderly loved ones all over Sydney. our team is well-prepared to support you at any stage.
